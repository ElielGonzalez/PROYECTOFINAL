  ...
  <body >
    ...
    <div class="contenedor">
        ...
        <ul class="list">
            ...
            <h3 class="p-3 mb-2 bg-dark text-white">Menú Administrador:  <?php echo $_SESSION['nombre']?></h3><br><br>
            ...
            <li class="list__item list__item--click">
                ...
                <ul class="list__show">
                    <li class="list__inside">
                        <a href="../vista/registroDocente.php" class="nav__link nav__link--inside">Nutriólogo</a>
                    </li>
    ...
    <br>
    <p style="text-align: center; font-size: 20px; ">Nutriólogos registrados</p>
