...
<?php
  ...
  $sql="SELECT g.nombreAlimento,p.tipoComida,concat_ws(' ',g.kcal,'kcal'),concat_ws(' ',g.grasa,'gr'),concat_ws(' ',g.hCarbono,'gr'),concat_ws(' ',g.proteina,'gr') FROM alumno a INNER JOIN plannutricional p on a.matricula = p.alumno_matricula INNER JOIN gestionalimentos g ON p.gestionAlimentos_idGesAlimento= g.idGesAlimento INNER JOIN dieta d on p.id_planAlimenticio= d.id_planAlimenticio WHERE d.dia='Lunes' AND a.matricula='$matricula'";
  $query=mysqli_query($mysqli,$sql);


   $sql="SELECT g.nombreAlimento,p.tipoComida,concat_ws(' ',g.kcal,'kcal'),concat_ws(' ',g.grasa,'gr'),concat_ws(' ',g.hCarbono,'gr'),concat_ws(' ',g.proteina,'gr') FROM alumno a INNER JOIN plannutricional p on a.matricula = p.alumno_matricula INNER JOIN gestionalimentos g ON p.gestionAlimentos_idGesAlimento= g.idGesAlimento INNER JOIN dieta d on p.id_planAlimenticio= d.id_planAlimenticio WHERE d.dia='Martes' AND a.matricula='$matricula'";
  ...
  $sql="SELECT g.nombreAlimento,p.tipoComida,concat_ws(' ',g.kcal,'kcal'),concat_ws(' ',g.grasa,'gr'),concat_ws(' ',g.hCarbono,'gr'),concat_ws(' ',g.proteina,'gr') FROM alumno a INNER JOIN plannutricional p on a.matricula = p.alumno_matricula INNER JOIN gestionalimentos g ON p.gestionAlimentos_idGesAlimento= g.idGesAlimento INNER JOIN dieta d on p.id_planAlimenticio= d.id_planAlimenticio WHERE d.dia='Jueves' AND a.matricula='$matricula'";
  $query3=mysqli_query($mysqli,$sql);

  $sql="SELECT g.nombreAlimento,p.tipoComida,concat_ws(' ',g.kcal,'kcal'),concat_ws(' ',g.grasa,'gr'),concat_ws(' ',g.hCarbono,'gr'),concat_ws(' ',g.proteina,'gr') FROM alumno a INNER JOIN plannutricional p on a.matricula = p.alumno_matricula INNER JOIN gestionalimentos g ON p.gestionAlimentos_idGesAlimento= g.idGesAlimento INNER JOIN dieta d on p.id_planAlimenticio= d.id_planAlimenticio WHERE d.dia='Viernes' AND a.matricula='$matricula'";
  $query4=mysqli_query($mysqli,$sql);

  $sql="SELECT g.nombreAlimento,p.tipoComida,concat_ws(' ',g.kcal,'kcal'),concat_ws(' ',g.grasa,'gr'),concat_ws(' ',g.hCarbono,'gr'),concat_ws(' ',g.proteina,'gr') FROM alumno a INNER JOIN plannutricional p on a.matricula = p.alumno_matricula INNER JOIN gestionalimentos g ON p.gestionAlimentos_idGesAlimento= g.idGesAlimento INNER JOIN dieta d on p.id_planAlimenticio= d.id_planAlimenticio WHERE d.dia='Sabado' AND a.matricula='$matricula'";
  $query5=mysqli_query($mysqli,$sql);

  $sql="SELECT g.nombreAlimento,p.tipoComida,concat_ws(' ',g.kcal,'kcal'),concat_ws(' ',g.grasa,'gr'),concat_ws(' ',g.hCarbono,'gr'),concat_ws(' ',g.proteina,'gr') FROM alumno a INNER JOIN plannutricional p on a.matricula = p.alumno_matricula INNER JOIN gestionalimentos g ON p.gestionAlimentos_idGesAlimento= g.idGesAlimento INNER JOIN dieta d on p.id_planAlimenticio= d.id_planAlimenticio WHERE d.dia='Domingo' AND a.matricula='$matricula'";
