   ...
   <nav class="navbar navbar-expand-lg navbar navbar-dark bg-primary" style="font-size:19px ;">
    ...
    <table id="tablax" class="content-table1">
        <thead>
            ...
            <th style="text-align: center">1. ¿Cuántas veces al día comes?l</th>
            <th style="text-align: center">2. ¿Cuál es la comida principal para tí?</th>
            <th style="text-align: center">3 ¿De qué consiste y cómo preparas/está hecha tu comida principal?</th>
            <th style="text-align: center">4. ¿Estás o has estado evitando alguna comida por razones de salud?</th>
            <th style="text-align: center">5. ¿Qué porcentaje de tu comida habitual forma la carne?</th>
            <th style="text-align: center">6. ¿Cuánto de tu comida habitual forma la verdura y los productos vegetarianos?</th>
