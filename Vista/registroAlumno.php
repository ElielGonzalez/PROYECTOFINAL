...
<html lang="en">
  ...
  <body class="">
    ...
    <h5 class="text-dark text-center">Registro de alumnos</h5>
    ...
    <form class="formulario1" id="formulario">
      ...
      <div class="formulario__grupo" id="grupo__matricula">
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="matricula" id="matricula" placeholder="EJ: VVF0181917">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
        </div>
        <p class="formulario__input-error">La matricula tiene que ser de 4 a 20 dígitos y solo puede contener numeros y letras</p>
      </div>
      ...
      <div class="formulario__grupo" id="grupo__nombreAlumno">
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="nombreAlumno" id="nombreAlumno" placeholder="EJ: Daniel">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
        </div>
      ...
      <div class="formulario__grupo" id="grupo__apellidoPpaterno">
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="apellidoPpaterno" id="apellidoPpaterno" placeholder="EJ: Villanueva">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
        </div>
        <p class="formulario__input-error">El apellido tiene que ser de 4 a 20 dígitos y solo letras y espacios, pueden llevar acentos.</p>
      </div>
      ...
      <div class="formulario__grupo" id="grupo__apellidoMaterno">
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="apellidoMaterno" id="apellidoMaterno" placeholder="EJ: Rodríguez">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
        </div>
        <p class="formulario__input-error">El apellido tiene que ser de 4 a 20 dígitos y solo letras y espacios, pueden llevar acentos.</p>
      </div>
    ...
    <div class="col-3">
      ...
      <div class="formulario__grupo" id="grupo__correo">
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="correo" id="correo" placeholder="EJ: elielgonzalez@gmail.com">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
        </div>
        <p class="formulario__input-error">El correo debe contener @ y .com</p>
      </div>
      <!-- Grupo: contrasenia-->
      ...
      <div class="formulario_grupo" id="grupo_nutriolgo_cedula">
        <label for="nutriolgo_cedula" class="formulario__label">Cédula nutriólogo</label>
        <div class="formulario__grupo-input">
  ...
  <br>
      ...
      <div class="formulario__grupo formulario__grupo-btn-enviar">
        <button type="submit" class="formulario__btn" onclick="regAlumno()">Registrar Alumno</button>
