	...
	formulario.addEventListener('submit', (e) => {
		...
		if(campos.matricula && campos.nombreAlumno && campos.apellidoPpaterno && campos.apellidoMaterno && campos.correo && campos.contrasenia){
			...
			$.post('../control/agregarAlumno.php',{matricula:matricula, nombreAlumno:nombreAlumno, apellidoPpaterno:apellidoPpaterno,
			 apellidoMaterno:apellidoMaterno, sexo:sexo, carrera_alumno:carrera_alumno, grupo_alumno:grupo_alumno, cuatrimestre:cuatrimestre, correo:correo, contrasenia:contrasenia, nutriolgo_cedula:nutriolgo_cedula})
...
function actAlumno(){
	...
	formulario.addEventListener('submit', (e) => {
		...
		if(campos.nombreAlumno){
			var matricula = $('#matricula').val();
			var nombreAlumno = $('#nombreAlumno').val();
			var apellifoPaterno = $('#apellifoPaterno').val();
			var ApellidoMaterno = $('#ApellidoMaterno').val();
			var sexo = $('#sexo').val();
			var carrera_alumno = $('#carrera_alumno').val();
			var grupo_alumno = $('#grupo_alumno').val();
			...
			$.post('../control/cambiarAlumno.php',{matricula:matricula, nombreAlumno:nombreAlumno, apellifoPaterno:apellifoPaterno,
			 ApellidoMaterno:ApellidoMaterno, sexo:sexo, carrera_alumno:carrera_alumno, grupo_alumno:grupo_alumno, cuatrimestre:cuatrimestre, correo:correo, contrasenia:contrasenia})
