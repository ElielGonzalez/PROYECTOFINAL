...
<html lang="en">
  ...
  <body class="">
      ...
      <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
              <a class="nav-link active" aria-current="page" href="../vista/listaHabitosAlimenticios.php">Lstar de registro de habitos</a>
            </li>
          </ul>
          <ul class="navbar-nav">
              <li class="nav-item dropdown">
    ...
    <h1 class="text-center">Sistema web servicio social UPEMOR</h1>
    <h5 class="text-center">Registro programa educativo</h5>

    <main>
    <form class="formulario" id="formulario" method="post" action="../control/agregarHabitos.php">
