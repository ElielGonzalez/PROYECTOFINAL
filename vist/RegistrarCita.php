    ...
    <form class="formularior" id="formulario" method="post" action="../control/EnviarCorreo.php">
      ...
      <div class="formulario__grupo" id="grupo__nombre">
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="nombre" id="nombre" placeholder="EJ: Cita con Sadra">
      ...
      <div class="formulario__grupo" id="grupo__mensaje">
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="mensaje" id="mensaje" placeholder="EJ: Cita con Sadra">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
        </div>
        <p class="formulario__input-error">El nombre tiene que ser de 4 a 20 dígitos y solo puede contener numeros, letras y guion bajo.</p>
      </div>
      ...
      <div class="formulario__grupo" id="grupo__correo">
        ...
        <div class="formulario__grupo-input">
          <input type="text" class="formulario__input" name="correo" id="correo" placeholder="EJ: Cita con Sadra">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
        </div>
        <p class="formulario__input-error">El nombre tiene que ser de 4 a 20 dígitos y solo puede contener numeros, letras y guion bajo.</p>
      </div>
      ...
      <div class="formulario__grupo" id="grupo__fecha">
         ...
         <div class="formulario__grupo-input">
          <input type="datetime-local" class="formulario__input" id="fecha" name="fecha">
          <i class="formulario__validacion-estado fas fa-times-circle"></i>
        </div>
      </div>
