...
<?php
  ...
  $sql="SELECT concat_ws(' ',a.nombreAalumno,a.apellifoPaterno),h.p1,h.p2,h.p3,h.p4,h.p5,h.p6,h.p7,h.p8,h.imagen FROM `historiaclinica` h INNER JOIN alumno a on h.alumno_matricula= a.matricula";
    ...
    <table id="tablax" class="content-table1">
        ...
        <tbody>
            ...
            <tr class="active-row">
              ...
              <th><img src="../control/<?php echo $row['imagen']; ?>" alt="imagen" style="width: 100px;"></th>
          
             

             
              <th style="text-align: center"><a href="../vista/editarHistoriaClinica.php?id=<?php echo $row['1'] ?>" class="btn btn-outline-primary" onclick="return confirmarActualizaAlu()">Editar</a></th>

              <th style="text-align: center"><a href="../control/eliminarHistorial.php?id=<?php echo $row['0'] ?>" class="btn btn-outline-danger" onclick="return confirmarEliminarAlu()">Eliminar</a></th>
            </tr>
            <?php } ?>
            </tbody>
    </table>
