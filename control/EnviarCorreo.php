...
try {
    ...
    $mail->Body    = "Hola: ".$nombre.utf8_decode(", Sistema de nutrcion, te recuerda que 
    tu proxima cita debes acudir en la siguiente fecha: ").$bodyEmail;
    if (!$mail->send()) {
        echo "No se envio el correo"; die();
    } 
    //echo "Se envio el correo prrote"; die();
    header("Location:../Vista/Correo.php?correo-enviado!!");
